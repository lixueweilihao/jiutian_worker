...
public class demo {
    public static void main(String[] args) throws Exception {
        ...
        // 求各个班级英语成绩平均分
//        DataStream<Double> avgScore1 = input.keyBy(0).countWindow(2).aggregate(new AverageAggrate());
        DataStream<Double> avgScore = input.keyBy(0).timeWindow(Time.of(3000, TimeUnit.MILLISECONDS)).aggregate(new AverageAggrate());
