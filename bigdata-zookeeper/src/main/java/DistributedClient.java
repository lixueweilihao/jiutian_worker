...
public class DistributedClient {
    ...
    private static String connectString = "10.3.7.232:2181,10.3.7.233:2181,10.3.6.20:2181";
    ...
    public void getConn() throws IOException {
        ...
        zk = new ZooKeeper(connectString, sessionTimeout, new Watcher() {
            ...
            public void process(WatchedEvent event) {
                ...
                System.out.println("收到监听通知1！"+event.getPath());
                System.out.println("收到监听通知2！"+event.getState());
                System.out.println("收到监听通知3！"+event.getType());
                System.out.println("收到监听通知3！"+event.getWrapper());
                System.out.println("收到监听通知4！"+event.toString());
    ...
    public static void main(String[] args) {
        ...
        System.out.println("targetUrl:"+tagetUrl);
        //4.执行具体的业务功能
